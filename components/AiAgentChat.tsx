        ...
        <div className="space-y-6">
          ...
          {messages.map((m) => (
            ...
            >
              <div
                className={`max-w-[85%] ${
                  m.role === "user" ? "bg-[#007200]" : "bg-gray-100"
      ...
      <div className="border-t border-gray-100 p-4 bg-white">
        <div className="space-y-3">
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              className="flex-1 px-4 py-2 text-sm border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-[#007200] focus:border-transparent"
              type="text"
              placeholder={
            ...
            <Button
              ...
              className="px-4 py-2 bg-[#007200] text-white text-sm rounded-full hover:bg-[#003900] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {status === "streaming"
                ? "AI is replying..."
                : status === "submitted"
